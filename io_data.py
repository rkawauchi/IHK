...
class Person(Base):
    ...
    health = sqlalchemy.Column(sqlalchemy.Float)
    ...
    def __init__(self, money, gender, age, health, perceived_health, district, state,
            classification):
        self.money = money
        self.gender = gender
        self.age = age
    ...
    def __repr__(self):
        return 'Person({0}, {1}, {2})'.format(self.money, self.health, self.perceived_health)
